    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li class="deroulant">
                ...
                <ul class="menu">
                    <li><router-link :to="{ name: 'home'}" @click=" displayMenu()">Résidence IRMAR</router-link></li>
                    <li><router-link :to="{ name: 'reverence'}" @click=" displayMenu()">Résidence Révérences (USP Tauvrais)</router-link></li>
